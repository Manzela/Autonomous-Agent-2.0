...
echo "== 5. Reminder: set Actions repo VARIABLES for the CD pipeline =="
cat <<'VARS'
  gh variable set GCP_PROJECT      --repo Manzela/Autonomous-Agent-2.0 --body autonomous-agent-2026
  gh variable set GCP_ZONE         --repo Manzela/Autonomous-Agent-2.0 --body us-central1-a
  gh variable set AR_REPO          --repo Manzela/Autonomous-Agent-2.0 --body us-central1-docker.pkg.dev/autonomous-agent-2026/autonomousagent-images
  gh variable set STAGING_VM       --repo Manzela/Autonomous-Agent-2.0 --body autonomousagent-staging-vm
  gh variable set PROD_VM          --repo Manzela/Autonomous-Agent-2.0 --body autonomousagent-vm
  gh variable set GCP_WIF_PROVIDER --repo Manzela/Autonomous-Agent-2.0 --body 'projects/<num>/locations/global/workloadIdentityPools/<pool>/providers/<provider>'
  gh variable set GCP_DEPLOY_SA    --repo Manzela/Autonomous-Agent-2.0 --body '<deploy-sa>@autonomous-agent-2026.iam.gserviceaccount.com'
VARS
